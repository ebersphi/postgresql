...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|--------|-----------|-----------|
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  userid | oid | pg_authid.oid OID de l'utilisateur qui a exécuté l'ordre SQL |
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  dbid | oid | pg_database.oid OID de la base de données dans laquelle l'ordre SQL a été exécuté |
...
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  queryid | bigint | Code de hachage interne, calculé à partir de l'arbre d'analyse de la requête. |
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  query | text | Texte d'une requête représentative |
...
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  calls | bigint | Nombre d'exécutions de la requête |
|    |    |    |    |    |    | 12 | 11 |  total_time  |double precision | Durée d'exécution de l'instruction SQL, en millisecondes |
|    |    |    |    |    |    | 12 | 11 |  min_time  | double precision | Durée minimum d'exécution de l'instruction SQL, en millisecondes |
|    |    |    |    |    |    | 12 | 11 |  max_time  | double precision | Durée maximum d'exécution de l'instruction SQL, en millisecondes |
|    |    |    |    |    |    | 12 | 11 |  mean_time  | double precision | Durée moyenne d'exécution de l'instruction SQL, en millisecondes |
|    |    |    |    |    |    | 12 | 11 |  stddev_time  | double precision | Déviation standard de la durée d'exécution de l'instruction SQL, en millisecondes |
...
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  rows  | bigint | Nombre total de lignes récupérées ou affectées par la requête  |
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  shared_blks_hit  | bigint | Nombre total de blocs lus dans le cache partagé par la requête |
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  shared_blks_read  | bigint | Nombre total de blocs lus hors cache partagé par la requête |
| 18 | 17 | 16 | 15 | 14 | 13 | 12 | 11 |  shared_blks_dirtied  | bigint | Nombre total de blocs modifiés dans le cache partagé par la requête |
